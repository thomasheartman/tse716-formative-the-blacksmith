...
% Subdirectory - here sectionfiles (don't add the filename extension eg .tex as a general good practice as it only works
% with import or input, not with include). - you can then include them with \import{/sectionfiles}{nameoffile}
% You can write directly into here, though it may be better to use the defined subfiles - you can use more and import or include them
...
% you can use subimport to include the other parts into the subfile
